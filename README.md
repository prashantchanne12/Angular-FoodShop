...
This application will be used to store the data of different dishes for a food shop.
...
```
cd existing_repo
git remote add origin https://gitlab.com/nvent-training/new-hires-2022/food-shop.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:3ee176eaf208600ee4cf998346db4282?https://gitlab.com/nvent-training/new-hires-2022/food-shop/-/settings/integrations)
